defmodule SbgInv.Web.FactionFigure do
  ...
  @required_fields_for_army_list [:figure_id]
  ...
  def changeset_for_army_list(model, params \\ %{}) do
    model
    |> cast(params, @required_fields_for_army_list)
    |> validate_required(@required_fields_for_army_list)
    |> cast_assoc(:figure)
  end
